...
// 2,行列の減法
Matrix4x4 Suctract(const Matrix4x4& m1, const Matrix4x4& m2) {
	return {
	    m1.m[0][0] - m2.m[0][0], m1.m[0][1] - m2.m[0][1], m1.m[0][2] - m2.m[0][2], m1.m[0][3] - m2.m[0][3], m1.m[1][0] - m2.m[1][0], m1.m[1][1] - m2.m[1][1],
	    m1.m[1][2] - m2.m[1][2], m1.m[1][3] - m2.m[1][3], m1.m[2][0] - m2.m[2][0], m1.m[2][1] - m2.m[2][1], m1.m[2][2] - m2.m[2][2], m1.m[2][3] - m2.m[2][3],
	    m1.m[3][0] - m2.m[3][0], m1.m[3][1] - m2.m[3][1], m1.m[3][2] - m2.m[3][2], m1.m[3][3] - m2.m[3][3],
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	Matrix4x4 resultSubtract = Suctract(m1, m2);
	Matrix4x4 inverseM1 = Inverse(m1);
	Matrix4x4 inverseM2 = Inverse(m2);
	Matrix4x4 transposM1 = Transpose(m1);
	Matrix4x4 transposM2 = Transpose(m2);
	...
	while (Novice::ProcessMessage() == 0) {
		...
		MatrixScreenPrintf(kColumnWidth * 5, 0, transposM1, "transposM1");
		MatrixScreenPrintf(kColumnWidth * 5, kRowHeight * 5, transposM2, "transeposM2");
